...
RUN chmod 0555 /usr/src/app/kubernetes-entrypoint.sh
...
ENV  S3GC_CHHOST=localhost \
 ...
 S3GC_CLUSTERNAME='' \
 S3GC_EXPECTED_REPLICAS=null \
 S3GC_AGE=0 \
 S3GC_USEAGE=0 \
 S3GC_SAMPLES=4 \
 S3GC_DELETEBATCHSIZE=1000 \
 S3GC_CHTIMEOUT=1800 \
 S3GC_CREATEDATABASE_FLAG=false \
 S3GC_DROP_COLLECTTABLE_FLAG=false \
 S3GC_USE_REMOVE_OBJECTS=true \
 S3GC_INTERACTIVE_FLAG=true \
